...
def get_dataloader_coco(datadir, train_bs, test_bs, dataidxs=None):
    ...
    train_ds = CocoSegmentation(datadir,
                                split='train',
                                transform=transform_train,
                                download_dataset=False,
                                data_idxs=dataidxs)
    test_ds = CocoSegmentation(datadir,
                               split='val',
...
def load_coco_data(datadir):
    ...
    train_ds = CocoSegmentation(datadir, split='train', transform=transform_train, download_dataset=False)
    test_ds = CocoSegmentation(datadir, split='val', transform=transform_test, download_dataset=False)
...
def partition_data(datadir, partition, n_nets, alpha):
    ...
    logging.info("********* partition data COCO ***************")
